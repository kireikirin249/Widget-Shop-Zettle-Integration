...
public class transactionsSDK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transactions_sdk);
    ...
    private class RefundCallback implements RefundsManager.Callback<CardPaymentPayload, RetrieveCardPaymentFailureReason> {
        ...
        public void onFailure(RetrieveCardPaymentFailureReason reason) {
            Toast.makeText(transactionsSDK.this, "Refund failed", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onSuccess(CardPaymentPayload payload) {
            ...
            Intent intent = new RefundsActivity.IntentBuilder(transactionsSDK.this)
                    .cardPayment(payload)
